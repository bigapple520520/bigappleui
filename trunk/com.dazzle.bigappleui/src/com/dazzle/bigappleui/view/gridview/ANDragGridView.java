/* 
 * @(#)DragGridView.java    Created on 2015-1-20
 * Copyright (c) 2015 ZDSoft Networks, Inc. All rights reserved.
 * $Id$
 */
package com.dazzle.bigappleui.view.gridview;
...
/**
 * 一个Item可拖动的GridView，灵感源于支付宝客户端
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2015-1-20 下午4:29:57 $
 */
public class ANDragGridView extends GridView {
    ...
    /** DragGridView控件距离屏幕顶部的偏移量 */
    private int mOffset2Top;
    /** DragGridView控件距离屏幕左边的偏移量 */
    ...
    public ANDragGridView(Context context) {
        this(context, null);
    }

    public ANDragGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ANDragGridView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 
     * @author xuan
     * @version $Revision: 1.0 $, $Date: 2015-1-20 下午4:49:12 $
     */
