...
public class ZoomImageView extends ImageView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mode == DRAG) {
                // 单击检查
                if ((spacing(pA.x, pA.y, pB.x, pB.y) < 50) && (System.currentTimeMillis() - clickDownTime < 500)) {
    ...
    // 判断是否移动
    public boolean checkMovce(float lastX, float lastY, float localX, float localY) {
