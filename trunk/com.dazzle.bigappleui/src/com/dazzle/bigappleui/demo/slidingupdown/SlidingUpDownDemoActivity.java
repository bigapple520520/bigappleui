...
public class SlidingUpDownDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 侧滑主界面
		View aboveView = LayoutInflater.from(this).inflate(
				R.layout.demo_slidingupdown_above, null);

		// 侧滑菜单左边的界面
		final View behindView = LayoutInflater.from(this).inflate(
				R.layout.demo_slidingupdown_behind, null);
