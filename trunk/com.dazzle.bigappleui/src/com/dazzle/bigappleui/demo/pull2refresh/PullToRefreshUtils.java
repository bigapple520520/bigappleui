...
public abstract class PullToRefreshUtils {
	...
	public static void simpleInit(Context context,
		...
		// 添加底部加载更多View
		final View pull2refresh_footer = LayoutInflater.from(context).inflate(
				ResourceResidUtils.getResidByLayoutName(context,
						"pull2refresh_footer"), null);
		final TextView pull2refresh_footer_textview = (TextView) pull2refresh_footer
				.findViewById(ResourceResidUtils.getResidByIdName(context,
						"pull2refresh_footer_textview"));
		final ProgressBar pull2refresh_footer_progress = (ProgressBar) pull2refresh_footer
				.findViewById(ResourceResidUtils.getResidByIdName(context,
			...
			public void onRefresh() {
				new AsyncTask<Object, Object, Object>() {
					...
					protected void onPostExecute(Object result) {
						...
						listView.onRefreshComplete("最新更新："
		...
		listView.setOnScrollListener(new AbsListView.OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				try {
					if (view.getPositionForView(pull2refresh_footer) == view
