...
public class SlidingMenuDemoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 侧滑菜单左边的界面
        View menuLeft = LayoutInflater.from(this).inflate(R.layout.demo_slidingmenu_menu_left, null);
        ...
        // 左边菜单界面，侧边的渐变效果
        slidingMenu.setShadowDrawable(R.drawable.demo_slidingmenu_menuleft_shadow);
        ...
        slidingMenu.setOnOpenListener(new OnOpenListener() {
            @Override
            public void onOpen() {
                Toast.makeText(SlidingMenuDemoActivity.this, "我侧滑到了左边菜单界面", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        slidingMenu.setOnCloseListener(new OnCloseListener() {
            @Override
            public void onClose() {
                Toast.makeText(SlidingMenuDemoActivity.this, "我侧滑到了主界面", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        slidingMenu.setSecondaryOnOpenListner(new OnOpenListener() {
            @Override
            public void onOpen() {
                Toast.makeText(SlidingMenuDemoActivity.this, "我侧滑到了右边边菜单界面", Toast.LENGTH_SHORT).show();
            }
        });
