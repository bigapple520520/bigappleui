...
public class ViewPagerLayout extends ViewGroup {
    ...
    private final int defaultScreen = 0;// 默认从0开始c
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != MeasureSpec.EXACTLY) {
            ...
            throw new IllegalStateException("ScrollLayout width only can run at EXACTLY mode!");
        }
        ...
        if (heightMode != MeasureSpec.EXACTLY) {
            ...
            throw new IllegalStateException("ScrollLayout heigh only can run at EXACTLY mode!");
        }
